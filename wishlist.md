...
| `find-skills` | `joe-bell/cva`, `.agents/skills/find-skills` | 6,861 on 2026-07-17 | Codex, Claude Code, Hermes AI, Cursor, Gemini CLI | Agent workflow, research, Skill discovery | Skill Discovery Desk | 5/6 concepts exercised directly; npx CLI search modeled but not executed without explicit trust | 7.1/10 | 2026-07-17 | Exploring | `demos/find-skills-discovery-desk/index.html` |
