...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `frontend-design` | `anthropics/skills`, `skills/frontend-design` | 161,533 on 2026-07-16 | Claude Code, Codex, Hermes AI | Frontend, UI, product gallery | Public gallery rebuild from scratch | Needs retro review against 80% protocol | Pending | 2026-07-10 | Exploring | Pending |
| `design-taste-frontend` | `Leonxlnx/taste-skill`, Open Design wrapper `skills/taste-skill` | 63,989 on 2026-07-16 | Claude Code, Codex, Hermes AI | Visual taste, anti-slop review | Taste Pass Studio demo | 9/10; official design-system package selection was not used because this static artifact is an aesthetic-native CSS page | 8.5/10 | 2026-07-16 | Published | `demos/design-taste-frontend-studio/index.html` |
| `design-review` | `garrytan/gstack`, Open Design wrapper `skills/design-review` | 122,159 on 2026-07-16 | Claude Code, Codex, Hermes AI | Design critique, QA | Full critique-to-redesign loop for one fresh page | Pending | Pending |  | Wishlist | Pending |
| `high-end-visual-design` | `Leonxlnx/taste-skill`, Open Design wrapper `skills/soft-skill` | 63,989 on 2026-07-16 | Claude Code, Codex, Hermes AI | Typography, layout polish, visual craft | New premium visual page or gallery detail view from zero | Pending | Pending |  | Wishlist | Pending |
| `design-consultation` | `garrytan/gstack`, `gstack design-consultation skill` | 122,159 on 2026-07-16 | Claude Code, Codex, Hermes AI | Brand system, tokens, design principles | Design system source-of-truth built from zero | Pending | Pending |  | Wishlist | Pending |
| `grill-me` | `mio-openliven/codex-grill-me-skill`, `skills/grill-me` | 2 on 2026-07-16 | Codex first; Claude Code and Hermes AI if adapted | Requirement grilling, decision pressure-test | Grill-Me Brief Builder demo | 7/8; source/context inspection was done by the agent before building, not automated inside the demo | 8/10 | 2026-07-14 | Published | `demos/grill-me-brief-builder/index.html` |
