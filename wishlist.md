...
| 6 | `d3-visualization` | `nexu-io/open-design`, `skills/d3-visualization/SKILL.md` | 81,448 | Data visualization, design | Build an explanatory D3 experience using interaction only where it improves understanding. | Wishlist |
